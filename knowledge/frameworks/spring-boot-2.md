...
- `spring-boot-2/A02` — **Java 8 oder 11 Minimum (since 2.0), Java 17 unterstützt (since 2.5.6) aber nicht erforderlich.** Spring-Boot 2.x baut unter Java 8/11/17. Bei Migration auf 3.x wird Java 17 Minimum. [src: https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.7-Release-Notes, since: 2.0]
...
- `spring-boot-2/A04` — **Spring-Boot 2.7 ist die letzte 2.x-Version (released 2022-05-19).** Danach kommt nur Spring-Boot 3.0 — kein 2.8. OSS-Support endete am 2023-11-18; kommerzieller Support (Tanzu Spring Runtime) bis 2026-08-25. [src: https://spring.io/projects/spring-boot/#support, since: 2.7]
...
- `spring-boot-2/C02` — **`@Transactional` auf Methoden, nicht auf Klassen.** Klassen-Level-Annotation macht jede public Method transaktional — auch unbeabsichtigte (`hashCode`, `equals`, Getter). Methoden-Level ist explizit und review-bar.
