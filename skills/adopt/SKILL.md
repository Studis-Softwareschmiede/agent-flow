...
- **Fehlt `db_scripts/run-migrations.sh` auch nach Skeleton-Kopie nicht** (Konflikt mit bestehendem Runner?) → Backlog „Bestehenden Migration-Runner gegen Fabrik-Pattern angleichen (§6)".
