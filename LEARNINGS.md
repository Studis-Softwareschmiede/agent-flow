...
| `architecture/R06` | 2026-05-30 | `knowledge/architecture.md` | Transactional Outbox: outbox-Tabelle in gleicher Transaktion schreiben, Relay (Polling/CDC) leitet an Broker weiter — kein 2PC, idempotente Consumer | [microservices.io/patterns/data/transactional-outbox](https://microservices.io/patterns/data/transactional-outbox.html) | train/knowledge/architecture-20260530-142002 | Proposed |
