...
- `Done` = alle Stories **terminal** (`done + verworfen == total`, terminale Menge `{Done, Verworfen}`; vom Board-Tool aus Rollup vorgeschlagen, vom Owner bestätigt — s. [[story-status-verworfen]] AC5).
