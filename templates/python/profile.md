# Projekt-Profil (Vorlage: python) — new-project füllt <…> aus
language: python
domains: []
frameworks: []          # optional Array, z.B. ["fastapi@0.115"] — siehe docs/architecture/framework-build-subsystem.md §3 (FastAPI kommt projekt-spezifisch)
build: "uv"             # Freitext (Backwards-Compat) ODER kanonisch: npm | pnpm | uv | maven | gradle | cargo | none — kanonisch aktiviert build-Pack-Loader
test: "uv run pytest"
