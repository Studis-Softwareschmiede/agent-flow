...
SECURITY_HEADERS: dict[str, str] = {
    ...
    # COEP `require-corp` ist bewusst OPT-IN (auskommentiert): es blockiert cross-origin
    # eingebettete Ressourcen (Bilder/Skripte/Fonts) ohne CORP/CORS und ist der
    # wahrscheinlichste stille App-Brecher. Nur einschalten, wenn du echte Cross-Origin-
    # Isolation brauchst (z.B. SharedArrayBuffer) UND alle Drittressourcen CORP/CORS liefern:
